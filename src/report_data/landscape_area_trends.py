...
def generate(
    ...
    species_conservation_landscapes = sum_by_col(
    ...
    country_isos = {k for k in species_conservation_landscapes.keys()}
    ...
    for iso in country_isos:
        species_conservation_landscape = species_conservation_landscapes.get(iso) or 0.0
